...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { descricao: @contato.descricao, informacao: @contato.informacao, observacoes: @contato.observacoes }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { descricao: @contato.descricao, informacao: @contato.informacao, observacoes: @contato.observacoes }
    assert_redirected_to contato_path(assigns(:contato))
  end
